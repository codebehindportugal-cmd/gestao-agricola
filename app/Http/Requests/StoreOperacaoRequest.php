...
class StoreOperacaoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Maquinas, alfaias e transporte da operacao: varios por operacao,
            // cada um com as suas horas ou km e o seu custo.
            'recursos' => 'nullable|array|max:50',
            'recursos.*.maquina_id' => 'nullable|exists:maquinas,id',
            'recursos.*.alfaia_id' => 'nullable|exists:alfaias,id',
            'recursos.*.nome' => 'nullable|string|max:255',
            'recursos.*.papel' => 'nullable|string|max:255',
            'recursos.*.unidades' => 'nullable|integer|min:1|max:100',
            'recursos.*.horas' => 'nullable|numeric|min:0',
            'recursos.*.km' => 'nullable|numeric|min:0',
            'recursos.*.custo_hora' => 'nullable|numeric|min:0',
            'recursos.*.custo_km' => 'nullable|numeric|min:0',
    ...
    public function messages(): array
    {
        return [
            ...
            'recursos.*.unidades.min' => 'O número de unidades tem de ser pelo menos 1.',
            'recursos.*.horas.min' => 'As horas não podem ser negativas.',
            'recursos.*.km.min' => 'Os km não podem ser negativos.',
            'recursos.*.custo_hora.min' => 'O custo por hora não pode ser negativo.',
            'recursos.*.custo_km.min' => 'O custo por km não pode ser negativo.',
