...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/operacoes/{operacao}/extrair-imagem', [OperacaoManagementController::class, 'extrairImagem'])->name('app.operacoes.extrair-imagem');
    Route::post('/operacoes/{operacao}/upload-imagem', [OperacaoManagementController::class, 'uploadImagem'])->name('app.operacoes.upload-imagem');
    ...
    Route::get('/calendario', [CompromissoManagementController::class, 'index'])->name('app.calendario.index');
    Route::post('/calendario', [CompromissoManagementController::class, 'store'])->name('app.calendario.store');
    Route::patch('/calendario/{compromisso}', [CompromissoManagementController::class, 'update'])->name('app.calendario.update');
    Route::post('/calendario/{compromisso}/concluir', [CompromissoManagementController::class, 'concluir'])->name('app.calendario.concluir');
    Route::post('/calendario/{compromisso}/reabrir', [CompromissoManagementController::class, 'reabrir'])->name('app.calendario.reabrir');
    Route::delete('/calendario/{compromisso}', [CompromissoManagementController::class, 'destroy'])->name('app.calendario.destroy');
    Route::get('/despesas', [DespesaManagementController::class, 'index'])->name('app.despesas.index');
